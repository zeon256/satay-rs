...
- Satay extensions under `x-satay` for typed string parsing, strict sentinel values, integer primitive overrides, enum variant names, and lossy optional fields.
