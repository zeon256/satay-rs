...
- Rust structs, flattened `allOf` object structs, `anyOf`/supported discriminator unions, string enums, primitive aliases, and constrained newtypes from `components.schemas`.
