...
- String enums are generated as strict Rust enums. Open string enum shapes such as `anyOf: [{type: string}, {type: string, enum: [...]}]` generate known variants plus `Other(String)` so unknown values round-trip.
