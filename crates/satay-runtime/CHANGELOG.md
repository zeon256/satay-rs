...
## [0.1.0](https://github.com/zeon256/satay-rs/releases/tag/satay-runtime-v0.1.0) - 2026-06-03

### Added

- add support for parse datetime
- add support for parse date
...
- update fast-float dep to fast-float2
- split docs
- dylint lints
